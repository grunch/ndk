...
class UnsignedEvent {
  ...
  factory UnsignedEvent.fromJson(Map<dynamic, dynamic> data) {
    ...
    return UnsignedEvent._(id, pubKey, createdAt, kind, tags, content);
  }
  ...
  @override
  bool operator ==(other) => other is UnsignedEvent && id == other.id;
  @override
  ...
  @override
  String toString() {
    return 'UnsignedEvent{pubKey: $pubKey, createdAt: $createdAt, kind: $kind, tags: $tags, content: $content, sources: $sources}';
  }

  UnsignedEvent copyWith({
    String? pubKey,
    int? createdAt,
    int? kind,
